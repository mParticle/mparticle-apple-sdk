# mParticle Localytics Kit (Localytics SDK 7.x)

This is the [Localytics](https://www.localytics.com) integration for the [mParticle Apple SDK](https://github.com/mParticle/mparticle-apple-sdk), built against the [Localytics SDK 7.x](https://github.com/localytics/Localytics-swiftpm).
...
```swift
.package(
    url: "https://github.com/mparticle-integrations/mparticle-apple-integration-localytics-7",
