...
- (void)testConstructIdentityApiRequest {
    ...
    [request setUserIdentity:@"customer id" identityType:MPUserIdentityCustomerId];
    [request setUserIdentity:@"email id" identityType:MPUserIdentityEmail];
    [request setUserIdentity:@"facebook id" identityType:MPUserIdentityFacebook];
    [request setUserIdentity:@"facebook audience id" identityType:MPUserIdentityFacebookCustomAudienceId];
    [request setUserIdentity:@"google id" identityType:MPUserIdentityGoogle];
    [request setUserIdentity:@"microsoft id" identityType:MPUserIdentityMicrosoft];
    [request setUserIdentity:@"yahoo id" identityType:MPUserIdentityYahoo];
    [request setUserIdentity:@"twitter id" identityType:MPUserIdentityTwitter];
