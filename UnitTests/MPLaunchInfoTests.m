...
- (void)testAnnotation {
    ...
    MPLaunchInfo_PRIVATE *launchInfo = [[MPLaunchInfo_PRIVATE alloc] initWithURL:url sourceApplication:sourceApp annotation:annotation];
    ...
    launchInfo = [[MPLaunchInfo_PRIVATE alloc] initWithURL:url sourceApplication:sourceApp annotation:annotation];
    XCTAssertTrue([launchInfo.annotation isKindOfClass:[NSString class]]);
    XCTAssertNotNil(launchInfo.annotation);
...
- (void)testCreation {
    MPLaunchInfo_PRIVATE *info = nil;
    info = [[MPLaunchInfo_PRIVATE alloc] initWithURL:[NSURL URLWithString:@"https://example.com"] sourceApplication:@"My app" annotation:@"My annotation"];
    XCTAssert(info);

    info = [[MPLaunchInfo_PRIVATE alloc] initWithURL:[NSURL URLWithString:@"https://example.com"] options:nil];
    XCTAssert(info);
}
