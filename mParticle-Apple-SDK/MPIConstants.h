...
#define MPCurrentEpochInMilliseconds                                           \
  @(trunc([[NSDate date] timeIntervalSince1970] * 1000))

#define STATE_MACHINE_DIRECTORY_PATH                                           \
  [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask,    \
                                       YES)[0]                                 \
      stringByAppendingPathComponent:@"StateMachine"];

#define MPIsNull(object)                                                       \
  ((object) == nil || (NSNull *)(object) == [NSNull null])
#define MPIsDictionary(object)                                                 \
  (!MPIsNull(object) && [object isKindOfClass:[NSDictionary class]])
#define MPIsArray(object)                                                      \
  (!MPIsNull(object) && [object isKindOfClass:[NSArray class]])
#define MPIsString(object)                                                     \
  (!MPIsNull(object) && [object isKindOfClass:[NSString class]])
#define MPIsNumber(object)                                                     \
  (!MPIsNull(object) && [object isKindOfClass:[NSNumber class]])

#define MPIsNonEmptyDictionary(object)                                         \
  (MPIsDictionary(object) && ((NSDictionary *)object).count > 0)
#define MPIsNonEmptyArray(object)                                              \
  (MPIsArray(object) && ((NSArray *)object).count > 0)
#define MPIsNonEmptyString(object)                                             \
  (MPIsString(object) && ((NSString *)object).length > 0)
...
typedef NS_ENUM(NSUInteger, MPJavascriptMessageType) {
  ...
  MPJavascriptMessageTypeCommerce =
      16 /** Product action, promotion or impression */
};
...
extern NSString
    *_Nonnull const kMPRemoteConfigCustomModulePreferenceSettingsKey;
...
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningBlockUnplannedEventAttributes;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningBlockUnplannedUserAttributes;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningBlockUnplannedIdentities;
...
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueDoc;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueDataPoints;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueMatch;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueType;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueValidator;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueDefinition;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueSchemaEverything;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueSchemaNothing;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueAdditionalProperties;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueUserAttributes;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueCustomEvent;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueCustomEventType;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueEventName;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueScreenView;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueScreenName;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueProductAction;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueUnknown;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueAddToCart;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueRemoveFromCart;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueCheckout;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueCheckoutOption;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueClick;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueViewDetail;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValuePurchase;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueRefund;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueAddToWishlist;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueRemoveFromWishlist;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValuePromotionAction;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueProductImpressions;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueCriteria;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueAction;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueImpressionUnknown;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueImpressionView;
extern NSString
    *_Nonnull const kMPRemoteConfigDataPlanningDataPlanVersionValueImpressionClick;
...
extern const NSTimeInterval MAXIMUM_SESSION_TIMEOUT DEPRECATED_MSG_ATTRIBUTE(
    "There is no longer a maximum session timout, the value is unlimited");
...
// Device (Need these in objective C until the classes that use them are
// refactored to Swift)
