...
@property (atomic, strong, nonnull) NSString *apiKey __attribute__((const));
@property (atomic, strong, nonnull) NSString *secret __attribute__((const));
...
/// DEPRECATED: use AppEnvironmentProvider instance method instead
+ (BOOL)isAppExtension;
