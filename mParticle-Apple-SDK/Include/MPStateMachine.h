...
@property(nonatomic, strong, nullable)
    MPLocationManager_PRIVATE *locationManager;
#endif
#endif
@end
...
- (void)configureCustomModules:
    (nullable NSArray<NSDictionary *> *)customModuleSettings;
