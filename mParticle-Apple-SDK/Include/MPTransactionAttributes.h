...
/**
 This class represents the atributes of a commerce event transaction. It is used
 in conjunction with MPCommerceEvent to represent a commerce event transaction.
 ...
 <b>Objective-C</b>
 <pre><code>
 MPTransactionAttributes *transactionAttributes = [[MPTransactionAttributes
 alloc] init];
...
/**
 The revenue amount of the commerce event transaction. It usually is the
 <b>sum(products x quantities) + tax + shipping</b>. However it may contain
 other values not listed in the formula, it will vary per company.
 */
