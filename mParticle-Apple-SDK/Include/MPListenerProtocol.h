 ...
 * @param objects is the arguments sent to this api, such as the MPEvent in
 * logEvent
 */
- (void)onAPICalled:(nonnull NSString *)apiName
...
- (void)onEntityStored:(MPDatabaseTable)tableName
            primaryKey:(nonnull NSNumber *)primaryKey
 ...
 */
- (void)onKitApiCalled:(nonnull NSString *)methodName
                 kitId:(int)kitId
                  used:(BOOL)used
               objects:(nonnull NSArray *)objects;
