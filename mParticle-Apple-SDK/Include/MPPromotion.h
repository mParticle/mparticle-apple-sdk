...
/**
 This class is a container for the information that represents a collection of
 promotions (one or more).

 <b>Usage:</b>

 <b>Swift</b>
 <pre><code>
 let promotionContainer = MPPromotionContainer(action: MPPromotionAction.View,
 ...
 <b>Objective-C</b>
 <pre><code>
 MPPromotionContainer *promotionContainer = [[MPPromotionContainer alloc]
 initWithAction:MPPromotionActionView promotion:promotion1];

 MPCommerceEvent *commerceEvent = [[MPCommerceEvent alloc]
 initWithPromotionContainer:promotionContainer];
...
/**
 ...
 @param action A value from the <b>MPPromotionAction</b> enum describing the
 promotion action
 @param promotion An instance of MPPromotion

 @see MPPromotionAction
 */
- (nonnull instancetype)initWithAction:(MPPromotionAction)action
                             promotion:(nullable MPPromotion *)promotion;
