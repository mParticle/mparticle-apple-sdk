...
/**
 Setting the category of an MPEvent adds a custom attribute using $Category as
 the key. Several integrations, such as Google Analytics, will use this key to
 perform data mapping. Other integrations will receive the attribute as
 $Category. Please reference the mParticle doc site for more information.
 */
...
@property(nonatomic, strong, nullable)
    NSDictionary<NSString *, id> *info DEPRECATED_MSG_ATTRIBUTE(
        "use customAttributes instead");

/**
 The name of the event to be logged (required not nil). The event name must not
...
/**
 ...
 @param name The name of the event to be logged (required not nil). The event
 name must not contain more than 255 characters.
...
- (nullable instancetype)initWithName:(nonnull NSString *)name
                                 type:(MPEventType)type
    __attribute__((objc_designated_initializer));

/**
 The duration, in milliseconds, of an event. You can set this property directly,
 use the beginTiming/endTiming methods to calculate it automatically,  or you
 can calll beginTimedEvent/endTimedEvent from the Mparticle sharedinstance to
