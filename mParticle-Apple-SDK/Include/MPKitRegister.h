...
/**
 Instance of the 3rd party kit wrapper implementation. The instance is allocated
 by the mParticle SDK and uses the class name provided by the className
 parameter. You should not set this property. It's lifecycle is managed by the
 mParticle SDK
 @see className
 @see MPKitProtocol
 */
...
/**
 Kit name. Obtained from the 3rd party library provider and informed to the Core
 SDK
 */
...
/**
 ...
 @param name Kit name. Obtained from the 3rd party library provider and informed
 to the Core SDK
 @param className Name of the class implementing the wrapper to forward calls to
 3rd party kits
 @returns An instance of a kit register or nil if a kit register could not be
 instantiated
 */
