...
- (nonnull MPKitExecStatus *)didFinishLaunchingWithConfiguration:
    (nonnull NSDictionary *)configuration;

// Value ignored for sideloaded kits, so a value like -1 is recommended,
// sideloadedKitCode is used instead which is set by the SDK
...
- (nonnull MPKitExecStatus *)
    continueUserActivity:(nonnull NSUserActivity *)userActivity
      restorationHandler:
          (void (^_Nonnull)(NSArray *_Nullable restorableObjects))
              restorationHandler;
- (nonnull MPKitExecStatus *)didUpdateUserActivity:
    (nonnull NSUserActivity *)userActivity;
- (nonnull MPKitExecStatus *)didBecomeActive;
- (nonnull MPKitExecStatus *)failedToRegisterForUserNotifications:
    (nullable NSError *)error;
- (nonnull MPKitExecStatus *)
    handleActionWithIdentifier:(nonnull NSString *)identifier
...
- (nonnull MPKitExecStatus *)receivedUserNotification:
...
#if TARGET_OS_IOS == 1 && __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_10_0
- (nonnull MPKitExecStatus *)
     userNotificationCenter:(nonnull UNUserNotificationCenter *)center
...
#if TARGET_OS_IOS == 1
#ifndef MPARTICLE_LOCATION_DISABLE
- (nonnull MPKitExecStatus *)beginLocationTracking:(CLLocationAccuracy)accuracy
                                       minDistance:
...
- (nonnull MPKitExecStatus *)incrementUserAttribute:(nonnull NSString *)key
                                            byValue:(nonnull NSNumber *)value;
- (nonnull MPKitExecStatus *)removeUserAttribute:(nonnull NSString *)key;
- (nonnull MPKitExecStatus *)setUserAttribute:(nonnull NSString *)key
                                        value:(nonnull id)value;
- (nonnull MPKitExecStatus *)setUserAttribute:(nonnull NSString *)key
                                       values:(nonnull NSArray *)values;
- (nonnull MPKitExecStatus *)setUserIdentity:(nullable NSString *)identityString
                                identityType:(MPUserIdentity)identityType;
- (nonnull MPKitExecStatus *)setUserTag:(nonnull NSString *)tag;

- (nonnull MPKitExecStatus *)onIncrementUserAttribute:
    (nonnull FilteredMParticleUser *)user;
- (nonnull MPKitExecStatus *)onRemoveUserAttribute:
    (nonnull FilteredMParticleUser *)user;
- (nonnull MPKitExecStatus *)onSetUserAttribute:
    (nonnull FilteredMParticleUser *)user;
- (nonnull MPKitExecStatus *)onSetUserTag:(nonnull FilteredMParticleUser *)user;

- (nonnull MPKitExecStatus *)
    onIdentifyComplete:(nonnull FilteredMParticleUser *)user
               request:(nonnull FilteredMPIdentityApiRequest *)request;
- (nonnull MPKitExecStatus *)
    onLoginComplete:(nonnull FilteredMParticleUser *)user
            request:(nonnull FilteredMPIdentityApiRequest *)request;
- (nonnull MPKitExecStatus *)
    onLogoutComplete:(nonnull FilteredMParticleUser *)user
             request:(nonnull FilteredMPIdentityApiRequest *)request;
- (nonnull MPKitExecStatus *)
    onModifyComplete:(nonnull FilteredMParticleUser *)user
             request:(nonnull FilteredMPIdentityApiRequest *)request;
...
- (nonnull MPKitExecStatus *)logCommerceEvent:
    (nonnull MPCommerceEvent *)commerceEvent __attribute__((deprecated));
- (nonnull MPKitExecStatus *)logLTVIncrease:(double)increaseAmount
                                      event:(nonnull MPEvent *)event;
...
- (nonnull MPKitExecStatus *)setATTStatus:(MPATTAuthorizationStatus)status
             withATTStatusTimestampMillis:
                 (nullable NSNumber *)attStatusTimestampMillis;
...
- (nonnull MPKitExecStatus *)logError:(nullable NSString *)message
                            eventInfo:(nullable NSDictionary *)eventInfo;
- (nonnull MPKitExecStatus *)logException:(nonnull NSException *)exception;

#pragma mark Assorted
- (nonnull MPKitExecStatus *)setKitAttribute:(nonnull NSString *)key
                                       value:(nullable id)value;
- (nonnull MPKitExecStatus *)setOptOut:(BOOL)optOut;
- (nullable NSString *)surveyURLWithUserAttributes:
    (nonnull NSDictionary *)userAttributes;
...
- (nonnull MPKitExecStatus *)
    executeWithIdentifier:(NSString *_Nullable)identifier
               attributes:
                   (NSDictionary<NSString *, NSString *> *_Nonnull)attributes
            embeddedViews:
                (NSDictionary<NSString *, MPRoktEmbeddedView *> *_Nullable)
                    embeddedViews
...
- (nonnull MPKitExecStatus *)setWrapperSdk:(MPWrapperSdk)wrapperSdk
                                   version:
                                       (nonnull NSString *)wrapperSdkVersion;
...
- (nonnull MPKitExecStatus *)events:(NSString *_Nonnull)identifier
                            onEvent:(void (^_Nullable)(MPRoktEvent *_Nonnull))
                                        onEvent;
