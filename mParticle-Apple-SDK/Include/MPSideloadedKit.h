 ...
 */
- (void)addEventTypeFilterWithEventType:(MPEventType)eventType NS_SWIFT_NAME(addEventTypeFilter(eventType:));
 ...
 */
- (void)addEventNameFilterWithEventType:(MPEventType)eventType eventName:(NSString *)eventName NS_SWIFT_NAME(addEventNameFilter(eventType:eventName:));
 ...
 */
- (void)addScreenNameFilterWithScreenName:(NSString *)screenName NS_SWIFT_NAME(addScreenNameFilter(screenName:));
 ...
 */
- (void)addEventAttributeFilterWithEventType:(MPEventType)eventType eventName:(NSString *)eventName customAttributeKey:(NSString *)customAttributeKey NS_SWIFT_NAME(addEventAttributeFilter(eventType:eventName:customAttributeKey:));
...
/**
 ...
 @param customAttributeKey The attribute key to filter
 */
- (void)addScreenAttributeFilterWithScreenName:(NSString *)screenName customAttributeKey:(NSString *)customAttributeKey NS_SWIFT_NAME(addScreenAttributeFilter(screenName:customAttributeKey:));
 ...
 */
- (void)addUserIdentityFilterWithUserIdentity:(MPUserIdentity)userIdentity NS_SWIFT_NAME(addUserIdentityFilter(userIdentity:));
 ...
 */
- (void)addUserAttributeFilterWithUserAttributeKey:(NSString *)userAttributeKey NS_SWIFT_NAME(addUserAttributeFilter(userAttributeKey:));
 ...
 */
- (void)addCommerceEventAttributeFilterWithEventType:(MPEventType)eventType eventAttributeKey:(NSString *)eventAttributeKey NS_SWIFT_NAME(addCommerceEventAttributeFilter(eventType:eventAttributeKey:));
 ...
 */
- (void)addCommerceEventEntityTypeFilterWithCommerceEventKind:(MPCommerceEventKind)commerceEventKind NS_SWIFT_NAME(addCommerceEventEntityTypeFilter(commerceEventKind:));
 ...
 */
- (void)addCommerceEventAppFamilyAttributeFilterWithAttributeKey:(NSString *)attributeKey NS_SWIFT_NAME(addCommerceEventAppFamilyAttributeFilter(attributeKey:));
 ...
 */
- (void)setEventAttributeConditionalForwardingWithAttributeName:(NSString *)attributeName attributeValue:(NSString *)attributeValue onlyForward:(BOOL)onlyForward NS_SWIFT_NAME(setEventAttributeConditionalForwarding(attributeName:attributeValue:onlyForward:));
 ...
 */
- (void)addMessageTypeFilterWithMessageTypeConstant:(NSString *)messageTypeConstant NS_SWIFT_NAME(addMessageTypeFilter(messageTypeConstant:));
 ...
 */
- (NSDictionary<NSString *, id> *)getKitFilters NS_SWIFT_NAME(getKitFilters());
