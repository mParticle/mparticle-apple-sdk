...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
            if ([kitRegister.wrapperInstance respondsToSelector:@selector(logBaseEvent:)] && ((selector == @selector(logEvent:)) || (selector == @selector(logBaseEvent:)))) {
            ...
            } else if (selector == @selector(executeWithIdentifier:attributes:embeddedViews:config:callbacks:filteredUser:options:)) {
                if (kitFilter.shouldFilter) {
                ...
                if ([kitRegister.wrapperInstance respondsToSelector:@selector(executeWithIdentifier:attributes:embeddedViews:config:callbacks:filteredUser:options:)]) {
                ...
                } else if ([kitRegister.wrapperInstance respondsToSelector:@selector(executeWithIdentifier:attributes:embeddedViews:config:callbacks:filteredUser:)]) {
                    execStatus = [kitRegister.wrapperInstance executeWithIdentifier:parameters[0]
                                                                         attributes:parameters[1]
                                                                      embeddedViews:parameters[2]
                                                                             config:parameters[3]
