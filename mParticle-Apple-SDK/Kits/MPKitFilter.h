...
- (nonnull instancetype)initWithEvent:(nonnull MPEventAbstract *)event shouldFilter:(BOOL)shouldFilter appliedProjections:(nullable NSArray<MPEventProjection *> *)appliedProjections;
