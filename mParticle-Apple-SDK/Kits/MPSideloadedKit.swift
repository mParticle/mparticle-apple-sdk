...
@objc public class MPSideloadedKit: NSObject {
    ...
    @objc public func addMessageTypeFilter(messageTypeConstant: String) {
        messageTypeFilters[messageTypeConstant] = 0
    }

    @objc public func getKitFilters() -> [String: Any] {
        var kitFilters: [String: Any] = [:]
        kitFilters["et"] = eventTypeFilters
        kitFilters["ec"] = eventNameFilters
        kitFilters["ea"] = eventAttributeFilters
        kitFilters["mt"] = messageTypeFilters
        kitFilters["svec"] = screenNameFilters
        kitFilters["svea"] = screenAttributeFilters
        kitFilters["uid"] = userIdentityFilters
        kitFilters["ua"] = userAttributeFilters
        kitFilters["cea"] = commerceEventAttributeFilters
        kitFilters["ent"] = commerceEventEntityTypeFilters
        kitFilters["afa"] = commerceEventAppFamilyAttributeFilters
        kitFilters["avf"] = attributeValueFiltering

        kitFilters["eaa"] = addEventAttributeList
        kitFilters["ear"] = removeEventAttributeList
        kitFilters["eas"] = singleItemEventAttributeList

        kitFilters["reg"] = consentRegulationFilters
        kitFilters["pur"] = consentPurposeFilters
