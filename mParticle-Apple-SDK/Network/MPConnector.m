...
+ (NSArray<NSString *> *)defaultPinnedCertificates {
    return @[
        ...
        @"", //GoDaddy TLS Root CA - R1
...
+ (void)initialize {
    if (self == [MPConnector class]) {
        mpStoredCertificates = [self defaultPinnedCertificates];
    }
}
