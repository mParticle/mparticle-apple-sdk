...
@objc public class MPUserDefaults : NSObject, MPUserDefaultsProtocol {
    ...
    required public init(stateMachine: MPStateMachine_PRIVATE, backendController: MPBackendControllerProtocol, identity: MPIdentityApi) {
    ...
    @objc public class func standardUserDefaults(stateMachine: MPStateMachine_PRIVATE, backendController: MPBackendControllerProtocol, identity: MPIdentityApi) -> MPUserDefaults {
        if userDefaults == nil {
