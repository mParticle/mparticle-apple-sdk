Pod::Spec.new do |s|
    s.name             = "mParticle-Apple-SDK-Umbrella"
    s.version          = "8.44.4"
    ...
    s.description      = <<-DESC
                         ...
                         Depends on `mParticle-Apple-SDK` and `RoktContracts`. Intended to be versioned and tagged with the main SDK.
                         DESC
    ...
    s.dependency 'mParticle-Apple-SDK', s.version.to_s
