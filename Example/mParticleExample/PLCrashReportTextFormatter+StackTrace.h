...
//        for (NSUInteger frame_idx = 0; frame_idx < [exception.stackFrames
//        count]; frame_idx++) {
//            PLCrashReportStackFrameInfo *frameInfo = [exception.stackFrames
//            objectAtIndex: frame_idx]; [stackTrace appendString:
//            [PLCrashReportTextFormatter formatStackFrame: frameInfo
//            frameIndex: frame_idx report: report lp64: lp64]];
//        }
...
//        PLCrashReportProcessorTypeEncodingMach)
//            continue;
//
...
//    }
//
//    /* If we were unable to determine the code type, fall back on the
//    processor info's value. */ if (codeType == nil &&
//    report.systemInfo.processorInfo.typeEncoding ==
//    PLCrashReportProcessorTypeEncodingMach) {
...
//
//            default:
//                codeType = [NSString stringWithFormat: @"Unknown (%llu)",
//                report.systemInfo.processorInfo.type]; lp64 = true; break;
//        }
//    }
//
