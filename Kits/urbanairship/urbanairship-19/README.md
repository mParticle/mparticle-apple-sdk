# mParticle Urban Airship Kit (Airship SDK 19.x)

This is the [Urban Airship](https://www.airship.com) integration for the [mParticle Apple SDK](https://github.com/mParticle/mparticle-apple-sdk), built against the [Airship SDK 19.x](https://github.com/urbanairship/ios-library).
...
```ruby
pod 'mParticle-UrbanAirship-19', '~> 9'
```
