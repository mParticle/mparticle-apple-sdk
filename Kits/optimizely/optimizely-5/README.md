# mParticle Optimizely Kit (Optimizely Swift SDK 5.x)

This is the [Optimizely](https://www.optimizely.com) integration for the [mParticle Apple SDK](https://github.com/mParticle/mparticle-apple-sdk), built against the [Optimizely Swift SDK 5.x](https://github.com/optimizely/swift-sdk).
...
```swift
.package(
    url: "https://github.com/mparticle-integrations/mparticle-apple-integration-optimizely-5",
...
```ruby
pod 'mParticle-Optimizely-5', '~> 9.0'
```
