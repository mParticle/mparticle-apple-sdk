...
@interface MPKitOptimizelyTests : XCTestCase
@end

@implementation MPKitOptimizelyTests
...
- (void)testlogEventWithValue {
    ...
    MPEvent *event = [[MPEvent alloc] initWithName:@"test" type:MPEventTypeClick];
    [event addCustomFlag:@"4" withKey:MPKitOptimizelyEventKeyValue];
    ...
    NSNumber *testValue = [NSNumber numberWithInt:4];
...
- (void)testlogCommerceEventWithCustomNameAndRevenue {
    ...
    [[mockClient expect] trackWithEventKey:@"testMapping" userId:OCMOCK_ANY attributes:OCMOCK_ANY eventTags:[OCMArg checkWithBlock:^BOOL(NSDictionary *value) {
...
- (void)testlogCommerceEventWithCustomNameRevenueAndUserId {
    ...
    [[mockClient expect] trackWithEventKey:@"testMapping" userId:@"User65656" attributes:OCMOCK_ANY eventTags:[OCMArg checkWithBlock:^BOOL(NSDictionary *value) {
        return [value[@"revenue"] isEqual:@1300];
    }] error:nil];
