# mParticle Firebase Kit (Firebase SDK 11.x)

This kit integrates [Firebase Analytics](https://firebase.google.com/docs/analytics) with the [mParticle Apple SDK](https://github.com/mParticle/mparticle-apple-sdk). It targets Firebase SDK major version 11.x.
